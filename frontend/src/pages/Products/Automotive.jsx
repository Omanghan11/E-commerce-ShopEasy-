  ...
  return (
    <div className="min-h-screen text-black bg-gray-100 p-6">
      ...
      <div
        ...
        style={{ backgroundImage: `url('${AutomotiveImage}')` }}
      >
        <h1 className="text-4xl font-bold mb-4">Automotive Products</h1>
        <p className="text-lg mb-6">Explore our range of automotive products.</p>
        <Link
          to="/"
