...
function Automotive() {
  ...
  // ✅ Fetch automotive products from backend
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("https://shopeasy-backend-sagk.onrender.com/api/products?category=Automotive");
  ...
  return (
    <div className="min-h-screen text-black bg-gray-100 p-6">
      ...
      <div
        ...
        style={{ 
          backgroundImage: `url('${AutomotiveImage}')`,
      ...
      >
        ...
        <div className="relative z-10 px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 drop-shadow-lg">Automotive Products</h1>
          <p className="text-base sm:text-lg mb-4 sm:mb-6 drop-shadow-md">Explore our range of automotive products.</p>
          <Link
            to="/"
          ...
          >
            ...
            >
              <div className="w-full h-48 bg-gray-50 rounded mb-4 overflow-hidden flex items-center justify-center">
                <img
                  src={(product.images && product.images[0]) || product.imageUrl || "/placeholder.png"}
                  alt={product.name}
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              ...
              <button
                ...
                className={`w-1/2 py-2 rounded transition-colors ${
                  !product.stock || product.stock <= 0
                    ? 'bg-gray-200 border border-gray-300 text-gray-400 cursor-not-allowed'
                    : 'text-[#364153] border border-[#364153] hover:bg-[#364153] hover:text-white cursor-pointer'
                }`}
              >
