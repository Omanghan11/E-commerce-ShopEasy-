...
function Fashion() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("${import.meta.env.VITE_API_URL || "https://shopeasy-backend-sagk.onrender.com"}/api/products?category=Fashion");
  ...
  return (
    <div className="min-h-screen text-black bg-gray-100 p-6">
      ...
      >
        ...
        <p className="text-lg mb-6">Explore our range of fashion products.</p>
        <Link
          to="/"
