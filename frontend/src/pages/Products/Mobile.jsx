    ...
    const fetchMobiles = async () => {
      try {
        const res = await fetch(
          "http://localhost:5000/api/products?category=Mobile"
        );
    ...
    <div className="min-h-screen text-black bg-gray-100 p-6">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">Mobile Products</h1>
          <p className="text-lg mb-6">Explore our range of mobile products.</p>
          <Link
            to="/"
